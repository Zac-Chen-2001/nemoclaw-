...
enum GatewayCommands {
    ...
    Start {
        ...
        /// Preload k3s/containerd images from host tar archives before k3s starts.
        ///
        /// Repeat this flag to pass multiple tar files. This is intended for
        /// air-gapped or unreliable-network environments where k3s must avoid
        /// pulling core images from external registries during first boot.
        #[arg(long = "k3s-image-tar", value_hint = ValueHint::FilePath)]
        k3s_image_tars: Vec<String>,
    },
